...
<body>
	...
	<div class="wrapper">
	    ...
	    <form class="wrapper__form" action="checkUpload" method="post" enctype="multipart/form-data">
	    ...
	    <form class="" action="checkBack" method="post">
			<input class="button_back" type="submit" value="<-- quay lại trang chủ"/>
		</form>
  	</div>
